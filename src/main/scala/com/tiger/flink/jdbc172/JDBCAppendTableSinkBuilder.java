...
import static com.tiger.flink.jdbc172.JDBCOutputFormat.DEFAULT_BATCH_INTERVAL;
...
public class JDBCAppendTableSinkBuilder {
	 ...
	 * @param properties the username of the JDBC connection.
	 */
	public JDBCAppendTableSinkBuilder setProperties(Properties properties) {
